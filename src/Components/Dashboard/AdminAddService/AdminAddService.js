...
const AdminAddService = () => {
    ...
    const onSubmitEvent = () => {
        ...
        fetch('https://lit-ocean-57294.herokuapp.com/addService', {
            method: 'POST',
            body: formData
        })
            ...
            <div className="row mt-5">
                ...
                <div className="col-md-9">
                    <div className="d-flex justify-content-between">
                        <h4 className="text-light">Add Service</h4>
                    ...
                    <div className="adminService p-4">
                        <form action="" onSubmit={handleSubmit(onSubmitEvent)}>
                            ...
                            <div className=" d-flex justify-content-end mt-2">
                                <button className="btn btn-light border border-dark" type="submit">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
