...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.1zqkw.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
...
client.connect(err => {
    ...
    app.post("/addOrder", (req, res) => {
        ...
        userServicesCollection.insertOne({ name, desc, email, service, price, image, paymentId })
            .then(result => {
                res.send(result.insertedCount > 0);
            })
    })
